...
const createBook = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await BookServices.createNewBook(book_data);
...
const updateBook = catchAsync(async (req: Request, res: Response) => {
  ...
  const { ...book_data } = req.body;
  const result = await BookServices.updateBook(book_data, book_id);
...
const allBooks = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await BookServices.gelAllBooks(filers, pagination);
...
const cateGoryBooks = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await BookServices.gelBooksByCategoryId(
    categoryID,
    pagination
  );
...
const bookDetails = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await BookServices.getBookDetails(id);
